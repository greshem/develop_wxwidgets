...
//wxCalendarCtrl::HitTest(wxPoint const&, wxDateTime*, wxDateTime::WeekDay*)
//wxDateTime::Add(wxDateSpan const&)
...
//wxDateTime::GetDayOfYear(wxDateTime::TimeZone const&) const
...
//wxDateTime::GetTm(wxDateTime::TimeZone const&) const
//wxDateTime::GetWeekDayName(wxDateTime::WeekDay, wxDateTime::NameFlags)
//wxDateTime::GetWeekOfMonth(wxDateTime::WeekFlags, wxDateTime::TimeZone const&) const
//wxDateTime::GetWeekOfYear(wxDateTime::WeekFlags, wxDateTime::TimeZone const&) const
...
//wxDateTime::MakeFromTimezone(wxDateTime::TimeZone const&, bool)
//wxDateTime::MakeTimezone(wxDateTime::TimeZone const&, bool)
//wxDateTime::ParseDateTime(wchar_t const*)
//wxDateTime::ParseDate(wchar_t const*)
//wxDateTime::ParseFormat(wchar_t const*, wchar_t const*, wxDateTime const&)
//wxDateTime::ParseRfc822Date(wchar_t const*)
//wxDateTime::ParseTime(wchar_t const*)
...
//wxDateTime::SetToWeekOfYear(int, unsigned short, wxDateTime::WeekDay)
...
//wxDateTime::Tm::Tm()
//wxDateTime::Tm::Tm(tm const&, wxDateTime::TimeZone const&)
//wxDateTime::UNow()
//wxNextMonth(wxDateTime::Month&)
//wxNextWDay(wxDateTime::WeekDay&)
//wxPrevMonth(wxDateTime::Month&)
//wxPrevWDay(wxDateTime::WeekDay&)
//
