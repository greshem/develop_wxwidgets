...
//########################################################################
	...
	wxGenericDirCtrl * m_genericDirCtrl1 = new wxGenericDirCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(500, 400), wxSUNKEN_BORDER, wxEmptyString, 0 );
	m_genericDirCtrl1->ShowHidden( false );
	middleSizer10->Add(m_genericDirCtrl1);
