...
//########################################################################
//fixme 添加 响应函数, 参考 wxwidgets 自带的 widgets 里面的 searchCtrl 的实用. 
    wxBoxSizer *middleSizer30 = new wxBoxSizer( wxHORIZONTAL );
	 //WxButtonSelect= new wxButton(this, ID_WXBUTTON_ONE , _("Demo"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, wxT("WxButton4"));
    
    wxSearchCtrl *m_srchCtrl = new wxSearchCtrl(this, -1, wxEmptyString, wxDefaultPosition, wxSize(150, -1) );

     middleSizer30->Add(m_srchCtrl, 0, wxALL, 10);
