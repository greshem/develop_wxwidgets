...
TestDialog::TestDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	//行20-------Buttono 响应-----------------------------------------------------------------
    wxBoxSizer *middleSizer31 = new wxBoxSizer( wxHORIZONTAL );
	 WxButtonSelect= new wxButton(this, ID_WXBUTTON_ONE , _("Demo22222"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, wxT("WxButton4"));
     middleSizer31->Add(WxButtonSelect, 0, wxALL, 10);
     topSizer->Add(middleSizer31, 0, wxALIGN_CENTRE);
    ...
    wxFontPickerCtrl* m_fontPicker = new wxFontPickerCtrl(this, PickerPage_Font,
                                        *wxSWISS_FONT,
                                        wxDefaultPosition, wxDefaultSize);
                                        //GetPickerStyle());
     middleSizer30->Add(m_fontPicker, 0, wxALL, 10);
