...
$template->process("tpl/name_header.tpl", $vars, "src_gen/".$name."Dialog.h") || die $template->error();
$template->process("tpl/name_cpp.tpl", $vars, "src_gen/".$name."Dialog.cpp") || die $template->error();
