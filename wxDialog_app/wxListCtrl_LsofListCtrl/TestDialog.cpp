...
//========================================================================
	...
	//WxButtonSelect= new wxButton(this, ID_WXBUTTON_ONE , _("Demo"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, wxT("WxButton4"));
    //StationListCtrl *m_StationCtrlList = new StationListCtrl(this, ID_LIST_STATION, wxDefaultPosition, wxDefaultSize, wxLC_REPORT);   
    LsofFileListCtrl *m_StationCtrlList = new LsofFileListCtrl(this, ID_LIST_STATION, wxDefaultPosition, wxSize(600,400), wxLC_REPORT);   

    //501数据获取.
    //    
    m_StationCtrlList->AddDemoData();
    //
     middleSizer30->Add(m_StationCtrlList, 0, wxALL, 10);
