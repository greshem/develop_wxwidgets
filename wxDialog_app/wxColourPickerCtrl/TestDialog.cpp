...
EVT_COLOURPICKER_CHANGED(PickerPage_Colour, TestDialog::OnColourChange)
...
//
	...
	wxColourPickerCtrl*    m_clrPicker = new wxColourPickerCtrl(this, PickerPage_Colour, *wxRED,
                                            wxDefaultPosition, wxDefaultSize );
                                            //GetPickerStyle());

     middleSizer30->Add(m_clrPicker, 0, wxALL, 10);
...
void  TestDialog::OnColourChange (wxColourPickerEvent& event)
{
