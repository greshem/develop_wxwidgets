...
TestDialog::TestDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	choice->Append(_T("A_disk"));
	choice->Append(_T("B_disk"));
	choice->Append(_T("C_disk"));
	choice->Append(_T("D_disk"));
	choice->Append(_T("E_disk"));
	choice->Append(_T("F_disk"));
	choice->Append(_T("G"));
	//choice->Add(wxT(" select Disk"));
